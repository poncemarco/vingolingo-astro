...
const $$Tyc = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "terminos" }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<main id="main-content"> <section id="hero"> <div class=""> <h1 class="text-black text-4xl my-12 dark:text-white">Términos y condiciones</h1> <h2 class="text-black text-2xl my-12 dark:text-white">¡Bienvenido a Casa Maya!</h2> <article class="text-gray-900"> <p class="text-black text-lg my-2 dark:text-white">
Estos términos y condiciones describen las reglas y regulaciones para el uso del sitio web de Casa Maya, ubicado en https://muuch-maaya.com.
                        Muuch Maaya Najo, una entidad legalmente constituida, opera y vende sus productos y servicios bajo el nombre comercial 'Casa Maya'. En estos términos y condiciones, 'Casa Maya', 'nosotros', 'nuestro' y 'nos' se refieren a Muuch Maaya Najo y sus afiliados.
<br>
Al acceder a este sitio web, asumimos que aceptas estos términos y condiciones. No continúes usando Casa Maya si no estás de acuerdo con todos los términos y condiciones establecidos en esta página.
</p> <h2 class="text-gray-900 text-2xl my-2 dark:text-white">
Cookies:
</h2> <p class="text-black text-lg my-2 dark:text-white">
El sitio web utiliza cookies para ayudar a personalizar tu experiencia en línea. Al acceder a Casa Maya, aceptaste utilizar las cookies necesarias.
...
<br> </p> <h2 class="text-gray-900 text-2xl my-2 dark:text-white">
Licencia:
</h2> <p class="text-black text-lg my-2 dark:text-white">
A menos que se indique lo contrario, Casa Maya y/o sus licenciantes poseen los derechos de propiedad intelectual de todo el material en Casa Maya. Todos los derechos de propiedad intelectual son reservados. Puedes acceder desde Casa Maya para tu uso personal sujeto a las restricciones establecidas en estos términos y condiciones.
                    
                        No debes:<br> <br>
Copiar o volver a publicar material de Casa Maya<br>
Vender, alquilar o sublicenciar material de Casa Maya<br>
Reproducir, duplicar o copiar material de Casa Maya<br>
Redistribuir contenido de Casa Maya<br>
Este acuerdo comenzará el fecha presente.<br> <br>
Partes de este sitio web ofrecen a los usuarios la oportunidad de publicar e intercambiar opiniones e información en determinadas áreas. Casa Maya no filtra, edita, publica ni revisa los comentarios antes de su presencia en el sitio web. Los comentarios no reflejan los puntos de vista ni las opiniones de Casa Maya, sus agentes y/o afiliados. Los comentarios reflejan los puntos de vista y opiniones de la persona que publica. En la medida en que lo permitan las leyes aplicables, Casa Maya no será responsable de los comentarios ni de ninguna responsabilidad, daños o gastos causados ​​o sufridos como resultado de cualquier uso o publicación o apariencia de comentarios en este sitio web.
<br>
Casa Maya se reserva el derecho de monitorear todos los comentarios y eliminar los que puedan considerarse inapropiados, ofensivos o que incumplan estos Términos y Condiciones.
<br>
...
Tienes derecho a publicar comentarios en nuestro sitio web y tienes todas las licencias y consentimientos necesarios para hacerlo;
                        ...
                        Por la presente, otorgas a Casa Maya una licencia no exclusiva para usar, reproducir, editar y autorizar a otros a usar, reproducir y editar cualquiera de tus comentarios en todas y cada una de las formas, formatos, o medios.
<br>
...
<br>
Si eres una de las organizaciones enumeradas en el párrafo 2 y estás interesada en vincularte a nuestro sitio web, debes informarnos enviando un correo electrónico a Casa Maya. Incluye tu nombre, el nombre de tu organización, la información de contacto, así como la URL de tu sitio, una lista de las URL desde las que tienes la intención de vincular a nuestro sitio web y una lista de las URL de nuestro sitio a las que te gustaría acceder. Espera 2-3 semanas para recibir una respuesta.
<br>
...
Mediante el uso de nuestro nombre corporativo; o
                        ...
                        No se permitirá el uso del logotipo de Casa Maya u otro material gráfico para vincular sin un acuerdo de licencia de marca comercial.
<br>
...
}, "/Users/marco_cap/Documents/CurrentProjects/vingolingo-front/src/pages/tyc.astro", void 0);

const $$file = "/Users/marco_cap/Documents/CurrentProjects/vingolingo-front/src/pages/tyc.astro";
const $$url = "/tyc";
